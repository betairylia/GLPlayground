...
/*
Modified From: http://glslsandbox.com/e#45673.0

    Auroras by nimitz 2017 (twitter: @stormoid)

    I wrote this on my smartphone while I was driving 88 mph on a winding road at night, in the rain
...
/*
Modified from: http://glslsandbox.com/e#45651.0
...
void mainImage_Box(out vec4 o, vec2 U)
...
void main( void )
{
	...
	vec4 colo = vec4(0.0), colo_Box = vec4(0.0);
	mainImage(colo, gl_FragCoord.xy);
    mainImage_Box(colo_Box, gl_FragCoord.xy);

	outColor = mix(colo, colo_Box, state);
}
